    ...
    (0, _createClass3.default)(Logger, [{
        ...
        value: function command(method, path) {
            if (method && path) {
                ...
                var sessionId = path.match(/[a-z0-9]{40}-[a-z0-9]{4}-[a-z0-9]{4}-[a-z0-9]{4}-[a-z0-9]{12}/);
                if (sessionId) {
                    this._sessionIdStorage = sessionId[0];
                }
            }
        }
        ...
        value: function data(_data) {
            ...
            if (_data && (this.logLevel === 'data' || this.logLevel === 'verbose')) {
                var sessionId = this._sessionIdStorage ? this._sessionIdStorage : '';
                this.log(_constants.COLORS.brown + 'DATA\t\t' + _constants.COLORS.reset + ' ' + sessionId + ' ' + _data);
            }
        }
        ...
        value: function result(_result) {
            ...
            var sessionId = this._sessionIdStorage ? this._sessionIdStorage : '';
            this.log(_constants.COLORS.teal + 'RESULT\t\t' + _constants.COLORS.reset + ' ' + sessionId + ' ' + _result);
        }
        ...
        value: function error(msg) {
            ...
            if (msg) {
                var sessionId = this._sessionIdStorage ? this._sessionIdStorage : '';
                this.log(_constants.COLORS.red + 'ERROR\t' + _constants.COLORS.reset + msg + sessionId, null);
            }
        }
